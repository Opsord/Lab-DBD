    ...
    <div class="row g-0">
        ...
        <div class="col-md-8">
            <div class="card-body">
                ...
                <p class="card-text">Intente ligar con una informatica pero no se deJava</p>
                                ...
                                <div class="col">
                                    <div class="card text-bg-warning mb-3" style="width: 11.4rem;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @if($playlists[$i]->id_playlist == $u_p->id_playlist)
                                            <p class="card-text"><small class="text-muted">{{$artist[$u_p->id_user -1]->name_user}}</small></p>
                                        </div>
                                        @endif
                                        @endforeach
                                    </div>
