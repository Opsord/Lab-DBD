...
@section('content')
    ...
    <div class="card text-bg-warning mb-3" style="max-width: 540px;">
        <div class="row g-0">
            <div class="col-md-4">
                <a href="https://ibb.co/Gt3BRf7"><img src="https://i.ibb.co/Gt3BRf7/zhiv-2.jpg" alt="zhiv-2"
                        borde="0"></a>
            </div>
            <div class="col-md-8">
                <div class="card-body">
                        ...
                        <div class="modal-content">
                            ...
                            <form action="{{ url('user/update') }}/{{ $user->id_user }}" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" class="form-control" name="password" placeholder="Password" value="{{ $user->pass_user }}">
                                    
                                    <input type="hidden" class="form-control" name="id_subscription"
                                        placeholder="id suscripcion" value="{{ $user->id_subscription }}">
                                    <div class="form-group mb-3">
                                        <input type="text" class="form-control" name="genre" placeholder="Gender"
                                            value="{{$user->genre}}">
                                    </div>
                    ...
                    @foreach ($user_playlists as $user_playlists)
                        <div class="col">
                            <div class="card text-bg-warning mb-3" style="width: 11.4rem;">
                                ...
                                <div class="card-body">
                                    <p class="card-text">
                                        {{ $playlists[$user_playlists->id_playlist - 1]->name_playlist }}
                                    </p>
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="col">
                                                    <div class="card text-bg-warning mb-3"
                                                        ...
                                                        <a href="https://ibb.co/K96Nm7K"><img
                                                                src="https://i.ibb.co/K96Nm7K/music-album-1.png"
                                                                alt="music-album-1" borde="0"></a>
                                                        <div class="card-body">
                                                            <p class="card-text">
                                                                {{ $playlists[$user_playlists->id_playlist - 1]->name_playlist }}
                                ...
                                <div class="card text-bg-warning mb-3" style="width: 11.4rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p class="card-text"><small
                                                class="text-muted">{{ $artist[$songs[$ul->id_song]->artist - 1]->name_user }}</small>
                                        </p>
                                    </div>
                                </div>
                            </div>
                    ...
                    @else
                        <div id="inam2" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                        ...
                                        <div class="row">
                                            @foreach ($user_like->random(4) as $ul)
                                                <div class="col">
                                                    <div class="card text-bg-warning mb-3" style="width: 11.4rem;">
                                                        <a
                                                            href="{{ url('songview') }}/{{ $songs[$ul->id_song]->id_song }}"><img
                                                                src="https://i.ibb.co/1rqXc67/zhiv-song-4.png"
                                                                alt="zhiv-song-4" borde="0"></a>
                                                        <div class="card-body">
                                                            <p class="card-text">{{ $songs[$ul->id_song]->name_song }}
                                                            </p>
                                                            <p class="card-text"><small
                                                                    class="text-muted">{{ $artist[$songs[$ul->id_song]->artist - 1]->name_user }}</small>
                                                            </p>
                                                ...
                                                <div class="col">
                                                    <div class="card text-bg-warning mb-3" style="width: 11.4rem;">
                                                        ...
                                                        <div class="card-body">
                                                            ...
                                                            <p class="card-text"><small
                                                                    class="text-muted">{{ $artist[$songs[$ul->id_song]->artist]->name_user }}</small>
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <button class="carousel-control-prev" type="button" data-bs-target="#inam2"
                                    data-bs-slide="prev">
                                    <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                    <span class="visually-hidden">Previous</span>
                                </button>
                                <button class="carousel-control-next" type="button" data-bs-target="#inam2"
                                    data-bs-slide="next">
